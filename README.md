...
```shell
oc apply --filename https://github.com/openshift-knative/knative-openshift-ingress/releases/download/v0.1.0/release.yaml
```
...
```shell
operator-sdk build quay.io/openshift-knative/knative-openshift-ingress:v0.1.0
docker push quay.io/openshift-knative/knative-openshift-ingress:v0.1.0
```
